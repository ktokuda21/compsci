...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFF00").s().p("AiuBmIkFjEIFHgLIBrk2IBuE0IFHAGIkCDIIBfE5IkPi4IkLC8g");
...
}).prototype = getMCSymbolPrototype(lib.star, new cjs.Rectangle(-43.6,-41.5,87.30000000000001,83.1), null);
...
if (reversed == null) { reversed = false; }
	...
	this.score_txt.lineWidth = 297;
	this.score_txt.parent = this;
	this.score_txt.setTransform(18.75,19.3,0.8605,1);

	this.star_mc = new lib.star();
	this.star_mc.name = "star_mc";
	this.star_mc.setTransform(212.3,356.6,1.2294,1.2888);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.star_mc},{t:this.score_txt}]}).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		this.star_mc = this.Layer_1.star_mc;
		this.score_txt = this.Layer_1.score_txt;
		this.score = 0;
		...
		this.star_mc.on("click", function() {
			...
			//Move star to a new random spot
			this.star_mc.x = Mathrandom() * 400 + 50;
			this.star_mc.y = Mathrandom() * 250 + 50;
		}.bind(this));
	}
	...
	this.Layer_1.setTransform(146.6,213.8,1,1,0,0,0,146.6,213.8);
...
// library properties:
lib.properties = {
	id: '8B71ADA8F5C14340B1A87D5745E2570F',
	width: 800,
	height: 600,
	fps: 30,
	color: "#FFFFFF",
...
an.compositions['8B71ADA8F5C14340B1A87D5745E2570F'] = {
